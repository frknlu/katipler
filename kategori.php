...
$getid=$_GET["id"];
	...
	$bul2=mysqli_query($con,"select * from kategori where kat_id='$getid'");
	
	$cek=mysqli_fetch_array($bul2);
...
<!-- Seo 2018-->
<meta name="description" content="<?php echo $cek["ad"]; ?>,Zabıt Katipleri Portalı, katipler.name.tr,On Parmak Sayfası, Memur Alımları, Kpss, Aöf, is ilanları, Uyap, Mahkeme Kararları, Memur Haberleri">
...
<link href="data:image/x-icon;base64," rel="icon" type="image/x-icon" />
    ...
    <title><?php echo $cek["ad"]; ?> - Katipler.name.tr</title>
    <!-- Bootstrap core CSS -->
...
<script id="dsq-count-scr" src="//katiplertr.disqus.com/count.js" async></script>
	...
	<br>
      <div class="row">
        <div class="col-md-8">
		  ...
		  <!-- -->
		  	<?php
			$bul=mysqli_query($con,"select * from makale where kat_id='$getid' ORDER BY tarih DESC");
...
while($cek_kat=mysqli_fetch_array($bul)){
	$ay = $aylar[date('m', strtotime($cek_kat["tarih"])) - 1];
echo'
...
<div class="col-md-12 post">
                    <div class="row">
                        <div class="col-md-12">
                            <h4>
                                <strong><a href="katip.php?oku='.$cek_kat["id"].'" class="post-title">'.$cek_kat["baslik"].'</a></strong></h4>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12 post-header-line">
                            <span class="glyphicon glyphicon-calendar">
                            </span>Tarih: '.date('d ', strtotime($cek_kat["tarih"])). $ay .date(' Y', strtotime($cek_kat["tarih"])).' | <span class="glyphicon glyphicon-comment"></span><a href="#">
                                <a href="katip.php?oku='.$getid.'#disqus_thread">Second article</a> Yorum</a> | <i class="icon-share"></i><a href="#">'.$cek_kat["hit"].' Görüntülenme</a> | <span class="glyphicon glyphicon-tags">
                                </span>Etiket : 
								<a href="#"><span class="label label-info">'.$cek_kat["etiket"].'</span></a> 

                        </div>
                    </div>
                    <div class="row post-content">
                        <div class="col-md-3">
                            <a href="katip.php?oku='.$cek_kat["id"].'">
                                <img style="display: block;height: auto;max-width: 100%;" src="'.$cek_kat["img_resim"].'" alt="" class="img-responsive">
                            </a>
                        </div>
                        <div class="col-md-8">
                            <p>
                               '.substr($cek_kat["icerik"],0,240).' ...
                            </p>
							<p><a class="btn btn-read-more" href="katip.php?oku='.$cek_kat["id"].'">Devamını Oku</a></p>
                        </div>
                    </div>
                </div>
