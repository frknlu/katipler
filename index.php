...
<!-- Seo 2018-->
<meta name="description" content="Zabıt Katipleri Portalı, katipler.name.tr,On Parmak Sayfası, Memur Alımları, Kpss, Aöf, is ilanları, Uyap, Mahkeme Kararları, Memur Haberleri">
...
<link href="data:image/x-icon;base64," rel="icon" type="image/x-icon" />
    <title>Katipler Portalı | Katipler.name.tr</title>
    <!-- Bootstrap core CSS -->
...
## Sayfa Degiskeninin alalim.
	...
	$kacar		=	4;
	## Kayıt Sayısı
	$ksayisi	=	mysqli_num_rows(mysqli_query($con,"select id from makale"));
	## Sayfa Sayısı
	...
	## Verileri Çekelim
	$bul=mysqli_query($con,"select * from makale order by tarih DESC limit $nereden,$kacar");
		
		while($cek=mysqli_fetch_array($bul)){
					extract($cek);
					$ay = $aylar[date('m', strtotime($cek["tarih"])) - 1];
$yrmid=$cek["id"];				
$yorumsayisi=mysqli_query($con,"select * from yorumlar where makale_id=$yrmid");
...
<div class="col-md-12 post">
                    ...
                    <div class="row">
                        <div class="col-md-12 post-header-line">
                            <span class="glyphicon glyphicon-calendar"></span>Tarih: '.date('d ', strtotime($cek["tarih"])). $ay .date(' Y', strtotime($cek["tarih"])).' | <span class="glyphicon glyphicon-comment"></span><a href="#">
                                '.$rowcountyrm.' Yorum</a> | <i class="icon-share"></i><a href="#">'.$cek["hit"].' Görüntülenme</a> | <span class="glyphicon glyphicon-tags">
                                </span>Etiket : 
                    ...
                    <div class="row post-content">
                        <div class="col-md-3">
                            <a href="katip.php?oku='.$cek["id"].'">
                                <img style="display: block;height: auto;max-width: 100%;" src="'.$cek["img_resim"].'" alt="" class="img-responsive">
                            </a>
                        </div>
                        <div class="col-md-8">
                            <p>
                               '.substr($cek["icerik"],0,240).' ...
                            </p>
                            <p><a class="btn btn-read-more" href="katip.php?oku='.$cek["id"].'">Devamını Oku</a></p>
                        </div>
                    </div>
                </div>
';
	...
	for ($i=1; $i<=$ssayisi; $i++){
		echo "<span style='text-align:center;margin:5px; border:1px dotted orange'><a href='index.php?s={$i}'";
		if($i == $sayfa){
			echo "class='aktif'";
		}
		echo ">{$i}</a></span>";
